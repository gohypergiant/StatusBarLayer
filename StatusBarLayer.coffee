...
class StatusBarLayer extends Layer
	...
	constructor: (@options={}) ->
		...
		battery3x_iOS11_SVG = ""
		powerSVG = "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 11 19'><polygon points='11 7.5 5.86 7.5 8 0 0 10.5 4.96 10.5 2 19 11 7.5' fill='#{@options.foregroundColor}' /></svg>"
